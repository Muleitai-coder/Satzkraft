...
4. [ ] Je Paket Feinspezifikation gegen den dann aktuellen Codestand abgeglichen (I–K-Änderungen an Editor/Store/Trainingsansicht). *Release 1 „O-Fix": erledigt 17.07.2026 (Feinspezifikation in Abschnitt 3, abgeglichen mit v0.22.3).*
5. [ ] Test- und Abnahmeplan je Release benannt (betroffene Testdateien, manuelle Checks, Testdaten). *Release 1 „O-Fix": erledigt 17.07.2026 (Abschnitt 3, F6).*
